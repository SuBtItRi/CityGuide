...
class Form {
    constructor(apiUrl) {
        ...
        this.haveAccount = document.getElementById('haveAccount');
    }
    ...
    async init() {
            ...
            if (this.passwordReg.value === this.repeatPasswordReg.value) {
                ...
                if (usernameTaken) {
                    ...
                    const postData = {
                        ...
                        password: await this.simpleHash(this.passwordReg.value),
        ...
        this.haveAccount.addEventListener('click', () => {
            this.regForm.style.display = 'none';
            this.logForm.style.display = 'flex';
        });
    }
}
